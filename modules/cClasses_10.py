...
class cClassOne(object):
    ...
    def __init__(self, NE=-1, NI=-1, cell_id=-1):
        ...
        lib.calcMeanW.argtypes = [  c_void_p,
                                    ndpointer(dtype=c_int, shape=(NE,)),
                                    c_int,
                                    ndpointer(dtype=c_int, shape=(NE,)),
                                    c_int
                                 ]
        ...
        lib.calcMeanF.argtypes = [  c_void_p,
                                    ndpointer(dtype=c_int, shape=(NE,)),
                                    c_int
                                 ]
        lib.calcMeanF.restype = c_double    # returns a double

        lib.calcMeanD.argtypes = [  c_void_p,
                                    ndpointer(dtype=c_int, shape=(NE,)),
                                    c_int
                                 ]
